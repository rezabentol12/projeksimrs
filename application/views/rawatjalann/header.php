        ...
        <div class="container">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="nav-item"><a href="http://localhost/CI/projek1/index.php/rawatinap/form_tampil" class="nav-link">Form input</a></li>
                <li class="nav-item dropdown"><a href="http://localhost/CI/projek1/index.php/rawatinap" class="nav-link has-dropdown">Tampilan data</a>
                  <ul class="dropdown-menu">
