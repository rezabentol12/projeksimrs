...
<?php echo form_open("Igd/proses_simpan");  ?>
...
<div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">No antrian</label>
                      <div class="col-sm-12 col-md-4">
...
<div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Akes/Aauransi</label>
                      <div class="col-sm-12 col-md-4">
                      <input type="text" name="askes_asuransi" class="form-control">
...
<div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">pertama mendaftar</label>
                      <div class="col-sm-12 col-md-4">
...
<div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pekerjaan penaggung jawab</label>
                      <div class="col-sm-12 col-md-4">
